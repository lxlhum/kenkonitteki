<?php
$silvers = (int)$_POST["account_silver_in"];
//echo $silver;
...
$input->SetTotal_fee($silvers*100*8);
...
//生成预付款订单
DBOperater::creatOrder($openId,1,$money*100*8);
...
<div class="container">
    <div class="starter-template">
        <h1>账户充银</h1>
        <p class="lead">充值金额<?php echo silvers*8; ?>元</p>
