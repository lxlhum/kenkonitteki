<?php
$golds = (int)$_POST["account_golds_in"];
//echo $golds;
...
$input->SetTotal_fee($golds*100*280);
...
//生成预付款订单
DBOperater::creatOrder($openId,1,$money*100*280);
...
<div class="container">
    <div class="starter-template">
        <h1>账户充金</h1>
        <p class="lead">充值金额<?php echo $golds*280; ?>元</p>

        <button type="button" onclick="callpay()" >标准微信支付</button>


        <div class="span12">
            <p color="red">注意：标准微信支付为实时到账，但是，标准微信支付需要扣除千分之六的手续费</p>
        </div>
    </div>
